                ...
                <div class="card profile-sidebar">
                    ...
                    <h5 class="mb-1"><?= htmlspecialchars($user['full_name']) ?></h5>
                        ...
                        <ul class="nav flex-column">
                            ...
                            <a class="nav-link" href="index.php?act=logout"><i class="fas fa-sign-out-alt me-2"></i> Đăng xuất</a>
                            <a class="nav-link" href="index.php?act=logo" ><i class="fas fa-sign-out-alt me-2"></i> Về trang chủ</a>
                            </ul>
                    </div>
                </div>
            </div>
                    ...
                    <?php endif; ?>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="profile">
                                <form method="post" action="view/save_profile.php" id="profileForm">
